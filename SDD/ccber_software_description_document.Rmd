...
Download files from [github.com/bvegetabile/ccber/tree/master/testfiles](https://github.com/bvegetabile/ccber/tree/master/testfiles)

From the directory where the files are saved run,
